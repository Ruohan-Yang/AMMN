...
if __name__ == '__main__':
    ...
    parser.add_argument('--outfile', '-f', type=str, default='log', help='record file')
    ...
    for repeat in range(args.repeats):
        ...
        args.outfile = 'log/' + args.dataset + '-' + time + '.txt'
        print(args)
        ...
        train_AMMN(args.model, train_data, val_data, test_data, my_model, args.epochs, args.learning_rate, args.outfile, args.epsilon, args.alpha, args.t)
